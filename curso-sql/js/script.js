...
const WHATSAPP_MESSAGE = "Hola, quiero mi cupo para el curso de SQL con PostgreSQL 🚀";

// Fecha y hora de inicio del curso (formato ISO). Se usa para el countdown del Hero.
// 21 de agosto de 2026, 7:00 pm hora Perú (UTC-5)
const COURSE_START_DATE = new Date("2026-08-21T19:00:00-05:00");

// TODO: Cupos totales y cupos restantes disponibles. Edita CUPOS_RESTANTES según inscripciones reales.
// El grupo es de máximo 15 estudiantes por cohorte (clases 100% personalizadas con seguimiento).
const CUPOS_TOTALES = 15;
